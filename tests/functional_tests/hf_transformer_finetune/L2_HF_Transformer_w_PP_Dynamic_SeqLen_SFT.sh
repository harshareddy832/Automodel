...
# per batch. Tests update_seq_len() / reset_pp_stage_shapes() code path.
# Uses 1f1b schedule (the CI model hf_mixtral_2l has only 2 layers, which is
# too few for interleaved1f1b with pp_size=2).
